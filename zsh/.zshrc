...
ks() {
  ...
  #context=$(find ~/dev/kubemgr -depth 1 -type d  | grep -v .git | fzf -x -m -e +s --reverse --bind=left:page-up,right:page-down --no-mouse)
  #cd $context
}

function opv2 ()
{
    docker exec -it $(docker ps -q --filter name=opcli) openstack $@
}
...
source /Users/gonz/dev/autoenv/activate.sh
# alias
alias vi='vim'
alias k='kubectl'
alias op='openstack'
